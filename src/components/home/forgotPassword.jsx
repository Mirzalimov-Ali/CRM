...
import { DemoInputs, DemoLabels, LoginContainer, LoginLeft, LoginLeftButton, LoginLeftLine, LoginLeftLogo, LoginRight, ForgotPasswordDiv } from './style'
    ...
    <LoginContainer>
        <LoginLeft>
            ...
            <div>
                ...
                <Link to={"/login/change-password"}><LoginLeftButton>Send</LoginLeftButton></Link>

                <LoginLeftLine/>

                <Link to={"/login"} style={{textDecoration: "none"}}><ForgotPasswordDiv>
                    <img src={leftArrow} alt="" />
                    <p style={{color: "black"}}>Back</p>
                </ForgotPasswordDiv></Link>
            </div>
        </LoginLeft>
