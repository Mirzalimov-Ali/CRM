...
export const NavbarRightButton = styled.button`
    ...
    cursor: pointer;
    border-radius: 4px;
    border: ${(props) => props.$eng ? "1px solid var(--600, #2C2669)" : "none"};
    background: ${(props)=> props.$eng ? "none" : "var(--600, linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), #2C2669)"};
    display: flex;
    justify-content: center;
    align-items: center;
`
