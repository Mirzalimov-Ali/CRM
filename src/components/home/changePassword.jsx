    ...
    <LoginContainer>
        <LoginLeft>
            ...
            <div>
                ...
                <p style={{marginTop: "-30px", opacity: "0.5", color: "black", marginBottom: "30px"}}>Please enter a new password for personal security</p>
                ...
                <DemoLabels htmlFor='Password'>Repeat new password</DemoLabels>
                <DemoInputs type={showPassword2 ? 'text' : 'password'} value={password2} onChange={(e) => setPassword2(e.target.value)} placeholder='Enter email address' id='Password' style={{margin: "8px 0 30px 0", position: "relative", display: "flex", justifyContent: "end", paddingRight: "60px"}}/>
                <div style={{position: 'absolute', display: "flex", justifyContent: "end", width: "483px", alignItems: "center", marginTop: "-68px", marginLeft: "-20px"}} >
                  {showPassword2 ? <FaEyeSlash style={{transform: "scale(1.5)", cursor: "pointer"}} onClick={togglePasswordVisibility2}/> : <FaEye style={{transform: "scale(1.5)", cursor: "pointer"}} onClick={togglePasswordVisibility2}/>}
                </div>

                <Link to={"/"}><LoginLeftButton>Next</LoginLeftButton></Link>
            </div>
        </LoginLeft>
